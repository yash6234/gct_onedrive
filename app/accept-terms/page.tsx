...
import TermsActions from "./AcceptTermsActions";
    ...
    <main className="night-wrap min-h-dvh grid place-items-center p-6">
      <section className="dark-card w-[680px] rounded-xl p-8 text-center">
        <header className="flex items-center justify-center gap-3 mb-6">
          ...
          <span className="text-neutral-300 text-[16px] leading-none">
        ...
        <p className="text-neutral-300 text-sm leading-6 max-w-[460px] mx-auto mb-6">
          As part of our efforts to improve your experience, we wanted to let
          you know that we have updated the Services Agreement.
        </p>
