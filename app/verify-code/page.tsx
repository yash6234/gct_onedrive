  ...
  return (
    <main className="night-wrap min-h-dvh grid place-items-center p-6">
      <section className="dark-card w-[680px] rounded-xl p-8 text-center relative">
        ...
        <h1 className="text-white text-2xl font-semibold mb-2">Enter your password</h1>
        ...
        <a className="link-dark" href={`/verify-code/other-methods?login=${encodeURIComponent(login)}`}>
